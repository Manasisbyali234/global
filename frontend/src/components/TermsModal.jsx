    ...
    const termsContent = {
        ...
        candidate: {
            ...
            sections: [
                ...
                { heading: 'Liability', content: 'TaleGlobal acts solely as an online intermediary connecting candidates with verified employers and does not guarantee interviews, employment, or offer letters. TaleGlobal shall not be liable for any act, omission, or representation made by employers, consultancies, or Placement Deans, nor for any loss financial, professional, or reputational arising from platform usage. In no event shall TaleGlobal\'s aggregate liability exceed the total fee paid by the candidate for the specific application that gave rise to such claim.' },
                ...commonLegalSections
            ]
        },
        candidateProfile: {
        ...
        placement: {
            title: 'Terms & Conditions for Placement Deans',
            sections: [
                { heading: 'Registration and Verification', content: 'Placement Deans must provide valid institutional credentials and official contact information. Your account will be verified before activation to ensure authenticity. Registration constitutes a legally binding electronic agreement under applicable laws.' },
