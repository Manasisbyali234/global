    ...
    const termsContent = {
        ...
        candidate: {
            ...
            sections: [
                ...
                { heading: 'Liability', content: 'TaleGlobal acts solely as an online intermediary connecting candidates with verified employers and does not guarantee interviews, employment, or offer letters. TaleGlobal shall not be liable for any act, omission, or representation made by employers, consultancies, or Placement Dean, nor for any loss financial, professional, or reputational arising from platform usage. In no event shall TaleGlobal\'s aggregate liability exceed the total fee paid by the candidate for the specific application that gave rise to such claim.' },
                { heading: 'Important Notices', content: 'Apart from the TaleGlobal platform fee, neither TaleGlobal nor any registered employer or consultancy will NOT collect additional payments from candidates. If such activity is found, please report it immediately to Contact@taleglobal.net. TaleGlobal or its registered employers on this platform will never ask for OTPs, bank details, or confidential financial information. If you encounter such activity, please report it immediately to contact@taleglobal.net. TaleGlobal will never ask for original documents such as mark sheets or certificates. TaleGlobal does not issue official offer letters. Offer letters will be sent directly by the employer to the candidate\'s registered email ID provided during signup, only after successfully clearing all stages of the interview process.' },
                ...commonLegalSections
            ]
        },
        candidateProfile: {
        ...
        placement: {
            title: 'Terms & Conditions for Placement Dean',
            sections: [
