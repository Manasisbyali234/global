    ...
    const termsContent = {
        ...
        candidate: {
            ...
            sections: [
                ...
                { heading: 'Important Notices', points: [
                    'Apart from the TaleGlobal platform fee, neither TaleGlobal nor any registered employer or consultancy will NOT collect additional payments from candidates. If such activity is found, please report it immediately to Contact@taleglobal.net.',
                    'TaleGlobal or its registered employers on this platform will never ask for OTPs, bank details, or confidential financial information. If you encounter such activity, please report it immediately to contact@taleglobal.net.',
                    'TaleGlobal will never ask for original documents such as mark sheets or certificates. TaleGlobal does not issue official offer letter. Offer letter will be sent directly by the employer to the candidate\'s registered email ID provided during signup, only after successfully clearing all stages of the interview process.'
                ]},
                ...commonLegalSections
            ]
        },
