        ...
        candidate: {
            ...
            sections: [
                ...
                { heading: 'Important Notices', points: [
                    'Apart from the TaleGlobal platform fee, neither TaleGlobal nor any registered employer or consultancy will NOT collect additional payments from candidates. If such activity is found, please report it immediately tosupport@taleglobal.net.',
                    'TaleGlobal or its registered employers on this platform will never ask for OTPs, bank details, or confidential financial information. If you encounter such activity, please report it immediately tosupport@taleglobal.net.',
