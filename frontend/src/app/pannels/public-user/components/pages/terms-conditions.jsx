                    ...
                    <div className="terms-container">
                        ...
                        <div className="terms-content">
                            ...
                            <div className={`accordion-section ${activeSection === 'legal' ? 'active' : ''}`}>
                                ...
                                <div className="accordion-content">
                                    <div className="accordion-body">
                                        <p>All users of TaleGlobal including employers, candidates, consultancies, and Placement Dean agree to comply with all applicable laws, regulations, and guidelines in force in India, including but not limited to:</p>
                                        <ul>
                            ...
                            <div className={`accordion-section ${activeSection === 'privacy' ? 'active' : ''}`}>
                                ...
                                <div className="accordion-content">
                                    <div className="accordion-body">
                                        <p>TaleGlobal is committed to protecting the privacy, security, and lawful use of personal information entrusted to it by all individuals using its website and services including employers, candidates, consultancies, and Placement Dean. This Privacy Policy outlines how TaleGlobal collects, processes, uses, stores, discloses, and protects personal information in accordance with the <em>Digital Personal Data Protection Act, 2023</em>, the <em>Information Technology Act, 2000</em>, and other applicable laws of India.</p>
                                ...
                                <div className="accordion-content">
                                    <div className="accordion-body">
                                        ...
                                        <ul>
                                            ...
                                            <li>The platform only provides digital infrastructure that enables interaction between candidates, employers, consultancies, and Placement Dean based on information voluntarily provided by such users.</li>
