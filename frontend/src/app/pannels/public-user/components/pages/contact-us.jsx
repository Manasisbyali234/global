                                        ...
                                        <div className="contact-info">
                                            <div className="contact-info-section">
                                                ...
                                                <div className="c-info-column">
                                                    ...
                                                    <p><a href="mailto:support@taleglobal.net" style={{color: '#1976d2 !important', textDecoration: 'underline !important', cursor: 'pointer !important', pointerEvents: 'auto !important', position: 'relative', zIndex: 999}}>support@taleglobal.net</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
