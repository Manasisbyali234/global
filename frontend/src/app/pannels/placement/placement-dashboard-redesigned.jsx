                                                ...
                                                <div className="form-fields">
                                                    ...
                                                    <div className="field-group">
                                                        ...
                                                        >
                                                            ...
                                                            <option value="Indian Institute of Technology (IIT) Gandhinagar">Indian Institute of Technology (IIT) Gandhinagar</option>
                                                            ...
                                                            <option value="National Institute of Technology (NIT) Jaipur">National Institute of Technology (NIT) Jaipur</option>
                                                            <option value="National Institute of Technology (NIT) Allahabad">National Institute of Technology (NIT) Allahabad</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Hyderabad">Indian Institute of Information Technology (IIIT) Hyderabad</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Bangalore">Indian Institute of Information Technology (IIIT) Bangalore</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Delhi">Indian Institute of Information Technology (IIIT) Delhi</option>
                                                            ...
                                                            <option value="Kalinga Institute of Industrial Technology (KIIT)">Kalinga Institute of Industrial Technology (KIIT)</option>
                                                            <option value="Siksha 'O' Anusandhan University">Siksha 'O' Anusandhan University</option>
                                                            ...
                                                            <option value="International Institute of Information Technology (IIIT) Allahabad">International Institute of Information Technology (IIIT) Allahabad</option>
                                                            <option value="Motilal Nehru National Institute of Technology">Motilal Nehru National Institute of Technology</option>
                                                            <option value="Indian School of Mines (ISM) Dhanbad">Indian School of Mines (ISM) Dhanbad</option>
                                                            ...
                                                            <option value="National Institute of Technology (NIT) Jalandhar">National Institute of Technology (NIT) Jalandhar</option>
                                                            ...
                                                            <option value="Indian Institute of Information Technology (IIIT) Gwalior">Indian Institute of Information Technology (IIIT) Gwalior</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Jabalpur">Indian Institute of Information Technology (IIIT) Jabalpur</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Kancheepuram">Indian Institute of Information Technology (IIIT) Kancheepuram</option>
                                                            <option value="Indian Institute of Information Technology (IIIT) Lucknow">Indian Institute of Information Technology (IIIT) Lucknow</option>
                                                            ...
                                                            <option value="CEG Anna University">CEG Anna University</option>
                                                            <option value="Andhra Pradesh State Skill Development Corporation">Andhra Pradesh State Skill Development Corporation</option>
                                                            ...
                                                            <option value="Centurion University">Centurion University</option>
                                                            <option value="Utkal University">Utkal University</option>
                                                            <option value="National Institute of Science and Technology (NIST)">National Institute of Science and Technology (NIST)</option>
                                                            <option value="CV Raman College of Engineering">CV Raman College of Engineering</option>
                                                            <option value="Institute of Technical Education and Research">Institute of Technical Education and Research</option>
                                                            ...
                                                            <option value="Sher-e-Kashmir University of Agricultural Sciences and Technology">Sher-e-Kashmir University of Agricultural Sciences and Technology</option>
                                                            ...
                                                            <option value="Indian Institute of Information Technology Naya Raipur">Indian Institute of Information Technology Naya Raipur</option>
                                                            <option value="Pt. Ravishankar Shukla University">Pt. Ravishankar Shukla University</option>
                                                            <option value="Madhya Pradesh Technical University">Madhya Pradesh Technical University</option>
