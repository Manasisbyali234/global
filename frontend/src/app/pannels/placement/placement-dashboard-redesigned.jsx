...
function PlacementDashboardRedesigned() {
    ...
    const handleUpdateProfile = async () => {
        ...
        if (primaryPhone && officialPhone && primaryPhone === officialPhone) {
            ...
            errors.collegeOfficialPhone = 'College official phone number must be different from primary phone number number';
        }
                                                        ...
                                                        >
                                                            ...
                                                            <ul style={{listStyle: 'none', margin: 0, padding: 0, maxHeight: '200px', overflowY: 'auto'}}>
                                                                {[{label: 'Select course name', value: ''}, ...[
                                                                    ...
                                                                    'Diploma - Nursing',
                                                                    // IIT Programs
                                                                    'IIT - B.Tech Computer Science Engineering',
                                                                    'IIT - B.Tech Electrical Engineering',
                                                                    'IIT - B.Tech Mechanical Engineering',
                                                                    'IIT - B.Tech Civil Engineering',
                                                                    'IIT - B.Tech Chemical Engineering',
                                                                    'IIT - B.Tech Aerospace Engineering',
                                                                    'IIT - B.Tech Engineering Physics',
                                                                    'IIT - B.Tech Mathematics and Computing',
                                                                    'IIT - B.Tech Biotechnology',
                                                                    'IIT - B.Tech Ocean Engineering',
                                                                    'IIT - M.Tech Computer Science Engineering',
                                                                    'IIT - M.Tech Electrical Engineering',
                                                                    'IIT - M.Tech Mechanical Engineering',
                                                                    'IIT - M.Tech Civil Engineering',
                                                                    'IIT - M.Tech Chemical Engineering',
                                                                    'IIT - M.Tech Artificial Intelligence',
                                                                    'IIT - M.Tech Data Science',
                                                                    'IIT - M.Tech VLSI Design',
                                                                    'IIT - M.Tech Robotics',
                                                                    'IIT - MBA',
                                                                    'IIT - M.Sc Mathematics',
                                                                    'IIT - M.Sc Physics',
                                                                    'IIT - M.Sc Chemistry',
                                                                    'IIT - Ph.D Engineering',
                                                                    'IIT - Ph.D Science',
                                                                    'IIT - Ph.D Management',
                                                                    // Research
                                                                    ...
                                                                    // Additional M.Tech Programs
                                                                    'M.Tech - Information Science and Engineering',
                                                                    ...
                                                                    'MBA - E-Commerce',
                                                                    // Additional BBA Specializations
                                                                    'BBA - Finance',
                                                                    'BBA - Marketing',
                                                                    ...
                                                                    'B.Sc - Catering Technology',
                                                                    // Additional M.Sc Programs
                                                                    ...
                                                                    'Diploma - Animation and Multimedia',
                                                                    ...
                                                                    'Diploma - Yoga and Naturopathy',
                                                                    'Diploma - Physiotherapy',
                                                                    'Diploma - Radiology',
                                                                    'Diploma - Medical Laboratory Technology',
                                                                    'Diploma - Optometry',
                                                                    'Diploma - Dental Mechanics',
                                                                    'Diploma - Ayurvedic Pharmacy',
                                                                    // Integrated Programs
                                                                    'B.Tech + M.Tech - Integrated Computer Science Engineering',
                                                                    'B.Tech + M.Tech - Integrated Electronics and Communication',
                                                                    'B.Tech + M.Tech - Integrated Mechanical Engineering',
                                                                    'B.Sc + M.Sc - Integrated Mathematics',
                                                                    'B.Sc + M.Sc - Integrated Physics',
                                                                    'B.Sc + M.Sc - Integrated Chemistry',
                                                                    'B.A. + M.A. - Integrated Economics',
                                                                    'B.A. + M.A. - Integrated English',
                                                                    'B.Com + M.Com - Integrated Commerce',
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (p1 && p2 && p1 === p2) {
                                            setFormErrors({...formErrors, phone: 'Primary phone number must be different from college official phone number', collegeOfficialPhone: 'College official phone number must be different from primary phone number'});
                                        } else {
                                            setFormErrors({...formErrors, phone: '', collegeOfficialPhone: formErrors.collegeOfficialPhone === 'College official phone number must be different from primary phone number' ? '' : formErrors.collegeOfficialPhone});
                                        }
                                    }}
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (p1 && p2 && p1 === p2) {
                                            setFormErrors({...formErrors, collegeOfficialPhone: 'College official phone number must be different from primary phone number', phone: 'Primary phone number must be different from college official phone number'});
                                        } else {
                                            setFormErrors({...formErrors, collegeOfficialPhone: '', phone: formErrors.phone === 'Primary phone number must be different from college official phone number' ? '' : formErrors.phone});
                                        }
                                    }}
